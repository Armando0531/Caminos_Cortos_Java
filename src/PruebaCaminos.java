...
/*
 * Referencias
 * GeeksforGeeks. (2021, 22 agosto). Dijkstra’s shortest path algorithm in Java using PriorityQueue. Recuperado 17 de diciembre de 2021, de 
 * https://www.geeksforgeeks.org/dijkstras-shortest-path-algorithm-in-java-using-priorityqueue/
 * 
 * GeeksforGeeks. (2021, 21 junio). Bellman Ford Algorithm (Simple Implementation). Recuperado 17 de diciembre de 2021, de 
 * https://www.geeksforgeeks.org/bellman-ford-algorithm-simple-implementation/
 * 
 * Programación en Java/Apéndices/Implementación del algoritmo de Floyd en Java - Wikilibros. (s. f.). WIKILIBROS. Recuperado 17 de diciembre de 2021, de 
 * https://es.wikibooks.org/wiki/Programaci%C3%B3n_en_Java/Ap%C3%A9ndices/Implementaci%C3%B3n_del_algoritmo_de_Floyd_en_Java
 * Implementación del algoritmo de Floyd en Java. (s. f.). Los diccionarios y las enciclopedias sobre el Académico. Recuperado 17 de diciembre de 2021, de 
 * https://es-academic.com/dic.nsf/eswiki/604316
 * 
 */
	...
	public static void main(String[] args) {
		...
		do {
			...
			case "1":
			   ...
			   PruebaCaminos dpq = new PruebaCaminos(V); 
